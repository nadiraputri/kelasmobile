...
const App = () => {
  ...
  return (
    <View style={{flex: 1, backgroundColor: '#FFDEAD'}}>
      ...
      <Icon name="chevron-circle-down" size={20} color="#A0522D" />Daftar Menu</Text>
      </View>
      </TouchableOpacity>
      {showMenu && (
        <View
      ...
      <TouchableOpacity
        ...
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
          <Text>10 Foto + File = 200.000</Text>
        </View>
      ...
      <TouchableOpacity
        ...
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
          <Text>10 Foto + File + Cetak = 500.000</Text>
        </View>
      ...
      <TouchableOpacity
        ...
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
          <Text>Sewa Camera = 50.000/Jam</Text>
        </View>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
          <Text>Sewa Tripod = 20.000/Jam</Text>
        </View>
      </TouchableOpacity>
      <TouchableOpacity
        style={{
        ...
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
          <Text>Sewa Tripod + Camera = 60.000/Jam</Text>
        </View>
      </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
          <Text>Sewa Properti Studio = 20.000/Jam</Text>
        </View>
      </TouchableOpacity>
      <TouchableOpacity
        style={{
